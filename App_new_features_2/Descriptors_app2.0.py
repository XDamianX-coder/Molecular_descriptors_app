...
new = generate(SMILES)
fig, ax = plt.subplots()
ax.hist(new['AromaticProportion'], bins=100)
...
new = generate(SMILES)
fig, ax = plt.subplots()
ax.hist(new['NumValenceElectrons'], bins=100)
...
fig, ax = plt.subplots()
ax.hist(new["MaxPartialCharge"], bins=100)
...
new = generate_2(SMILES)
fig, ax = plt.subplots()
ax.hist(new["MinPartialCharge"], bins=100)
